...
{
    [CustomEditor(typeof(EadonRpgCharacter))]
    public class EadonRpgCharacterInspector : EadonBaseEditor
    {
...
//        private SerializedObject serializedObject;
        ...
        {
            editorTitle = "Eadon Character Instance";
            splashTexture = (Texture2D) Resources.Load("Textures/eadon_rpg_character", typeof(Texture2D));
            showExpandButton = false;
            _character = (EadonRpgCharacter) target;
//            serializedObject = serializedObject;
        }

        protected override void OnBaseInspectorGUI()
        {
            string[] tabs = {"General", "Core", "Stats", "Skills", "Resistances", "Weight"};
        ...
        private void DrawGeneralTab()
        {
            ...
            var clothingManager = serializedObject.FindProperty("clothingManager");
            ...
            EditorGUILayout.PropertyField(clothingManager, new GUIContent("Clothing Manager"), false);
        ...
        private void DrawWeightTab()
        {
            var enableWeightLimits = serializedObject.FindProperty("enableWeightLimits");
            var messageWhenOverweight = serializedObject.FindProperty("messageWhenOverweight");
            var messageWhenNotOverweight = serializedObject.FindProperty("messageWhenNotOverweight");
            var forceWalkWhileOverweight = serializedObject.FindProperty("forceWalkWhileOverweight");
            var disableStrafeWhileOverweight = serializedObject.FindProperty("disableStrafeWhileOverweight");
            var disableJumpWhileOverweight = serializedObject.FindProperty("disableJumpWhileOverweight");
            var jumpMessage = serializedObject.FindProperty("jumpMessage");
            var disableRollWhileOverweight = serializedObject.FindProperty("disableRollWhileOverweight");
            var rollMessage = serializedObject.FindProperty("rollMessage");
            var disableSprintWhileOverweight = serializedObject.FindProperty("disableSprintWhileOverweight");
            var sprintMessage = serializedObject.FindProperty("sprintMessage");
            var walkOverweightSpeed = serializedObject.FindProperty("walkOverweightSpeed");
            var runningOverweightSpeed = serializedObject.FindProperty("runningOverweightSpeed");
            var sprintOverweightSpeed = serializedObject.FindProperty("sprintOverweightSpeed");
            
            EditorGUILayout.PropertyField(enableWeightLimits, new GUIContent("Enable Weight Limits"), false);
            if (enableWeightLimits.boolValue)
            {
                EditorGUILayout.Space();
                
                EditorGUILayout.PropertyField(messageWhenOverweight, new GUIContent("Message When Overweight"), false);
                EditorGUILayout.PropertyField(messageWhenNotOverweight, new GUIContent("Message When Not Overweight"), false);
                EditorGUILayout.PropertyField(forceWalkWhileOverweight, new GUIContent("Force Walk While Overweight"), false);
                EditorGUILayout.PropertyField(disableStrafeWhileOverweight, new GUIContent("Disable Strafe While Overweight"), false);
                EditorGUILayout.PropertyField(disableJumpWhileOverweight, new GUIContent("Disable Jump While Overweight"), false);
                EditorGUILayout.PropertyField(jumpMessage, new GUIContent("Jump Message"), false);
                EditorGUILayout.PropertyField(disableRollWhileOverweight, new GUIContent("Disable Roll While Overweight"), false);
                EditorGUILayout.PropertyField(rollMessage, new GUIContent("Roll Message"), false);
                EditorGUILayout.PropertyField(disableSprintWhileOverweight, new GUIContent("Disable Sprint While Overweight"), false);
                EditorGUILayout.PropertyField(sprintMessage, new GUIContent("Sprint Message"), false);
                
                EditorGUILayout.Space();
                
                EditorGUILayout.PropertyField(walkOverweightSpeed, new GUIContent("Walk Overweight Speed"), false);
                EditorGUILayout.PropertyField(runningOverweightSpeed, new GUIContent("Running Overweight Speed"), false);
                EditorGUILayout.PropertyField(sprintOverweightSpeed, new GUIContent("Sprint Overweight Speed"), false);
            }
        }
    }
}
