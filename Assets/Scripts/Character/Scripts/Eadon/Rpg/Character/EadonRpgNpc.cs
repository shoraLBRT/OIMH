...
using System.Linq;
#if EADON_USE_INVECTOR
using Eadon.AI.Controllers.Invector;
#endif
...
{
    public class EadonRpgNpc : EadonRpgCharacterBase
    {
        private vControlAI _controller;
        private vFSMBehaviourController _fsmBehaviourController;

#if EADON_USE_INVECTOR
        private EadonAiInvectorController _invectorAiController;
#endif
        ...
        {
            base.Start();
            _controller = GetComponent<vControlAI>();
        }
        ...
        public override void FreezeController(bool freezeRigidbody, float duration = 5)
        {
            ...
            if (_fsmBehaviourController != null)
            {
                _fsmBehaviourController.isStopped = true;
            }
#if EADON_USE_INVECTOR
            if (_invectorAiController != null)
            {
                _invectorAiController.isFrozen = true;
            }
#endif
        }
        ...
        public override void UnfreezeController()
        {
            ...
            if (_fsmBehaviourController != null)
            {
                _fsmBehaviourController.isStopped = false;
            }
#if EADON_USE_INVECTOR
            if (_invectorAiController != null)
            {
                _invectorAiController.isFrozen = false;
            }
#endif
        }
