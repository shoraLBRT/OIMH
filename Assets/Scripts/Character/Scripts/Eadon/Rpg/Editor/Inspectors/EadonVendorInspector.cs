...
{
    [CustomEditor(typeof(EadonVendor))]
    public class EadonVendorInspector : EadonBaseEditor
    {
        private static readonly string[] ExcludedProperties = new string[] { "m_Script" };

        void OnEnable()
        {
            editorTitle = "Eadon RPG Vendor";
            splashTexture = (Texture2D)Resources.Load("Textures/eadon_vendor", typeof(Texture2D));
