...
namespace Invector.vItemManager
{
    ...
    public class vInventory : vMonoBehaviour
    {
        ...
        public vShooterMeleeInput Playercamera;
        ...
        {
            Book.active = true;
            Player.SetBool("Inventory", true);
            Player.Play("Inventory");
            Playercamera.ChangeCameraStateWithLerp("InventoryCam");
        ...
        public virtual void CloseInventory()
        {
            ...
            if (updatedTimeScale)
            {
                ...
                Player.SetBool("Inventory", false);
                Book.active = false;
                Playercamera.ChangeCameraStateWithLerp("Default");
            }
        ...
        internal virtual void InspectItem (vItem item)
        {
