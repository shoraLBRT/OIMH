...
namespace Eadon.EadonRPG.Scripts.Editor
{
    public class EadonBaseEditor : UnityEditor.Editor
    {
        #region Variables
        ...
        private const string _showHelpboxesPrefs = "Eadon_ShowHelpbox";
        ...
        public override void OnInspectorGUI()
        {
            ...
            // version info
            EditorGUILayout.LabelField(string.Format("{0} {1}", EadonRpgInvectorData.Name, EadonRpgInvectorData.Version), subtitleStyle,
                GUILayout.Height(20));
