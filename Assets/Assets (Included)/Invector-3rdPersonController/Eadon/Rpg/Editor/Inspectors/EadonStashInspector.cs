...
namespace Eadon.RPG
{
    [CustomEditor(typeof(EadonStash))]
    public class EadonStashInspector : EadonBaseEditor
    {
        ...
        void OnEnable()
        {
            ...
            splashTexture = (Texture2D)Resources.Load("Textures/eadon_stash", typeof(Texture2D));
