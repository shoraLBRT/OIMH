...
{
    [CustomEditor(typeof(EadonRpgSimpleNpc))]
    public class EadonRpgSimpleNpcInspector : EadonBaseEditor
    {
        private int _selectedTab;
//        private SerializedObject serializedObject;
        private EadonRpgSimpleNpc _character;
        ...
        {
            editorTitle = "Eadon RPG Simple NPC";
            splashTexture = (Texture2D) Resources.Load("Textures/eadon_rpg_simplenpc", typeof(Texture2D));
            showExpandButton = false;
            _character = (EadonRpgSimpleNpc) target;
