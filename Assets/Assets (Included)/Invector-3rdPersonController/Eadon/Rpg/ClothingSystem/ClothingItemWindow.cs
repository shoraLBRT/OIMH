...
namespace Eadon.Rpg.Invector.ClothingSystem
{
    ...
    public class ClothingItemWindow : vMonoBehaviour
    {
        ...
        public virtual void CreateEquipmentWindow(List<vItem> items, List<vItemType> type, int holder, vItem currentItem = null, UnityAction<vItemSlot> onPickUpItemCallback = null, UnityAction<vItemSlot> onSelectSlotCallBack = null)
        {
            var finalItemList = new List<vItem>();
            ...
            else
            {
                foreach (var item in _items)
                {
                    ...
                    {
                        if (attribute.name == vItemAttributes.ClothingHolder && attribute.value == holder)
                        {
                            finalItemList.Add(item);
                        }
                    }
            ...
            StartCoroutine(CreateEquipmentWindowRoutine(finalItemList, onPickUpItemCallback, destroyAdictionSlots: true));
        }
